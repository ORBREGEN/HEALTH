      ...
      <section className="faq-hero">
        <div className="wrap">
          ...
          <h1 className="about-headline" style={{ marginTop: "28px", maxWidth: "640px" }}>
            Everything you need<br />to <em>understand ORBREGEN.</em>
          </h1>
        </div>
      </section>
        ...
        <div className="wrap">
          <div className="faq-layout">
            ...
            <div className="faq-groups">
              ...
              <section className="faq-group" id="the-platform">
                ...
                <div className="faq-list">
                  <details className="faq-item">
                    <summary className="faq-q">What is ORBREGEN?</summary>
                    <div className="faq-a">
                      <p>ORBREGEN is a biological intelligence platform built across four interconnected layers: a patient intake and matching system, an AI engine built from human cell data, an expert network of certified physicians, and a treatment intelligence layer currently in development.</p>
                  ...
                  <details className="faq-item">
                    <summary className="faq-q">Who is ORBREGEN for?</summary>
                    <div className="faq-a">
                      ...
                      <ul>
                        ...
                        <li><strong>Clinicians</strong> — certified respiratory physicians who review AI-surfaced findings, annotate cases, and contribute to model improvement.</li>
                        <li><strong>Researchers</strong> — academic and clinical research teams who access the AI engine via the research API for non-commercial work.</li>
                      </ul>
                    </div>
                  </details>
                  <details className="faq-item">
                    ...
                    <div className="faq-a">
                      <p>ORBREGEN is currently in clinical preview with eleven research partner sites. We are opening access to additional pulmonology groups, hospital systems, and rural-care networks progressively through 2026. To request access, use the form on the main page.</p>
                    </div>
                  </details>
                  <details className="faq-item">
                    ...
                    <div className="faq-a">
                      ...
                      <p><strong>Layer 2 — AI intelligence engine.</strong> A biological model built from the Human Lung Cell Atlas. It learns what a healthy human body looks like at the cellular level — starting with the lung — and describes deviations from that baseline.</p>
              ...
              <section className="faq-group" id="the-ai">
                <h2 className="faq-group-title">The AI</h2>
                <div className="faq-list">
                  <details className="faq-item">
                  ...
                  <details className="faq-item">
                    <summary className="faq-q">Does ORBREGEN diagnose diseases?</summary>
                    <div className="faq-a">
                  ...
                  <details className="faq-item">
                    ...
                    <div className="faq-a">
                      <p>In the pilot cohort, the model achieved 94.2% anomaly recall. This figure is reported with full transparency: it reflects performance on the specific cohort and conditions evaluated, and should not be generalised beyond that context without further validation on your population.</p>
                    </div>
                  </details>
                  <details className="faq-item">
                    <summary className="faq-q">Is the AI a black box?</summary>
                    <div className="faq-a">
              ...
              <section className="faq-group" id="for-clinicians">
                ...
                <div className="faq-list">
                  <details className="faq-item">
                    ...
                    <div className="faq-a">
                      <p>Specialists receive structured cases — not raw inboxes. Each case surfaces the AI-flagged findings alongside the original signal, with provenance and confidence on every claim. Clinicians can confirm findings, refine them, or disagree, and each decision is captured as structured supervision that feeds back into the next training cycle.</p>
                    </div>
                  </details>
                  <details className="faq-item">
                    <summary className="faq-q">Are clinicians compensated for their time?</summary>
                    <div className="faq-a">
                      <p>Yes. Time spent reviewing and annotating cases is paid. Specialists are partners in the model — not unpaid labellers. The platform is designed so that expert contribution is worth making, and the compensation reflects that.</p>
                    </div>
                  </details>
                  <details className="faq-item">
              ...
              <section className="faq-group" id="privacy">
                ...
                <div className="faq-list">
                  <details className="faq-item">
                    <summary className="faq-q">What compliance standards does ORBREGEN meet?</summary>
                    <div className="faq-a">
              ...
              <section className="faq-group" id="access">
                ...
                <div className="faq-list">
                  <details className="faq-item">
                    ...
                    <div className="faq-a">
                      <p>ORBREGEN is in clinical preview. Access is available to pulmonology groups, hospital systems, and rural-care networks by application. Use the request form on the main page — we typically respond within five business days.</p>
                    </div>
                  </details>
                  <details className="faq-item">
                    <summary className="faq-q">Is there a research API?</summary>
                    <div className="faq-a">
                      <p>Yes. The ORBREGEN AI engine is available to academic partners under a data-use agreement. Access is free for non-commercial publications. Reproducibility is built in — every finding is traceable to the source statistics. Contact us through the research API path on the main page.</p>
                    </div>
                  </details>
                  <details className="faq-item">
